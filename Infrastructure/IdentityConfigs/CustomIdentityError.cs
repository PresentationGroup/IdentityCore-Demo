...
namespace  Infrastructure.IdentityConfigs
{
    ...
    {
        public override IdentityError DefaultError() { return new IdentityError { Code = nameof(DefaultError), Description = $"یک خطای نامشخص رخ داده است." }; }
        ...
        public override IdentityError PasswordRequiresNonAlphanumeric() { return new IdentityError { Code = nameof(PasswordRequiresNonAlphanumeric), Description = "کلمه عبور باید حداقل یک کاراتر غیر الفبایی از این موارد داشته باشد : !@#$%^&*)(_+!" }; }
